		...
		var inner_modal = new PKSimpleModal({
			...
			setup:function( q ) {
			  ...
			  q._evtoggle = function ( val ) {
				  ...
				  if (val) el.innerHTML = 'BẬT';
				  else el.innerHTML = 'TẮT';									
			  };
			  ...
			  q._updatePresets = function ( fx_id, presets ) {
				  ...
				  edit_presets.innerHTML = '...<span>Lưu hoặc Sửa đổi cài đặt trước</span>';
